...
public class EventOptions {
    ...
    private static List<String> sortedListOfEvents() {
        List<String> events = new java.util.ArrayList<>(List.of("register", "login", "code_to_token", "logout", "client_login", "refresh_token", "introspect_token", "federated_identity_link",
                ...
                "execute_actions", "execute_action_token", "client_info", "client_register", "client_update", "client_delete", "client_initiated_account_linking", "federation_client_register", "federation_client_update", "token_exchange",
                ...
                "invite_org", "remove_totp", "update_totp", "update_password", "group_membership_create", "group_membership_update", "group_membership_delete", "group_membership_suspend"));
