...
- Show OpenID Federation configuration endpoint
...
### Fixed
- Fix bug with offline refresh token flow with Revoke Refresh Token being true [RCIAM-76](https://tts.grnet.gr/jira/browse/RCIAM-76)
...
## [22.0.13-1.17] - 2025-05-28

### Fixed
- Fix Name Id Policy Format for IDP's and IDP-Federations
...
- Identity Provider Redirector based on authentication session
