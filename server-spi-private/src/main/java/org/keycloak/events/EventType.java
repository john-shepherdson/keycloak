...
public enum EventType implements EnumWithStableIndex {
    ...
    FEDERATION_CLIENT_REGISTER(56, true),
    FEDERATION_CLIENT_REGISTER_ERROR(0x10000 + FEDERATION_CLIENT_REGISTER.getStableIndex(), true),
    FEDERATION_CLIENT_UPDATE(57, true),
    FEDERATION_CLIENT_UPDATE_ERROR(0x10000 + FEDERATION_CLIENT_UPDATE.getStableIndex(), true),
