...
public class OAuth2IdentityProviderConfig extends IdentityProviderModel {
    ...
    public static final String CLIENT_ASSERTION_SIGNING_ALG = "clientAssertionSigningAlg";
    ...
    public String getClientAssertionSigningAlg() {
        return getConfig().get(CLIENT_ASSERTION_SIGNING_ALG);
    }
    
    public void setClientAssertionSigningAlg(String signingAlg) {
        getConfig().put(CLIENT_ASSERTION_SIGNING_ALG, signingAlg);
    }
